# Generated by Django 3.2.21 on 2023-11-06 01:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('documentocol', models.FileField(db_column='Documentocol', upload_to='imagenes/')),
                ('empresa_idempresa', models.ForeignKey(db_column='empresa_idEmpresa', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'db_table': 'documento',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('empresa_idempresa', models.ForeignKey(db_column='empresa_idEmpresa', on_delete=django.db.models.deletion.DO_NOTHING, to=settings.AUTH_USER_MODEL)),
                ('puntosdeportivos', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='parches.puntosdeportivos')),
            ],
            options={
                'db_table': 'actividad',
